        ...
        <Box>
            ...
            <Flex>
                {IssueList.map((issue, index) => (
                    <Flex as="button" key={issue.Id} w="calc(100% / 3)" p="sp3" borderRadius="16px 16px 0 0"
                ...
                <Flex direction="column" gap="sp5"
                    ...
                    <Flex direction={{ base: "column", lg: "row" }} w="100%" justify={{ lg: "space-around" }}
                        ...
                        {IssueList[ActiveIndex].PolicyList.map(policy => (
                            <Flex key={policy.Id} pos="relative" zIndex="10"
                                  direction="column" align="center" gap="sp2"
                                  w={{ lg: "320px" }} px={{ lg: "sp4" }}>
